...
namespace behaviac
{
	...
	[behaviac.GeneratedTypeMetaInfo()]
	class Condition_bt_HoverBotBT_node6 : behaviac.Condition
	{
		public Condition_bt_HoverBotBT_node6()
		{
		}
		protected override EBTStatus update_impl(behaviac.Agent pAgent, behaviac.EBTStatus childStatus)
		{
			...
			// children
			{
				...
				}
				{
					...
					node0.AddChild(node5);
					{
						...
						{
							Condition_bt_HoverBotBT_node6 node6 = new Condition_bt_HoverBotBT_node6();
